      ...
      <div className="container mx-auto px-6" ref={ref}>
        <div className="text-center mb-20">
          ...
          <p className="text-primary-foreground/40 max-w-2xl mx-auto text-lg font-light">
            Über 5.000 zufriedene Mandanten vertrauen auf unsere Expertise. Lesen Sie echte Erfahrungsberichte.
          </p>
        </div>
        ...
        <div className={`flex justify-center mb-16 ${isVisible ? "animate-blur-in" : "opacity-0"}`}>
          <div className="glass-dark px-8 py-4 flex items-center gap-5">
            ...
            <div>
              ...
              <span className="text-sm text-primary-foreground/40 ml-2">/ 5.0</span>
            </div>
            <div className="w-px h-8 bg-white/10" />
            <span className="text-sm text-primary-foreground/50">247 Google Bewertungen</span>
          </div>
        </div>
