...
const AboutSection = () => {
  ...
  return (
    <section id="ueber-uns" className="py-28 bg-card relative overflow-hidden">
            ...
            <div className="space-y-5">
              {[
                ...
                <div key={item} className="flex items-start gap-4 group">
                  <div className="w-6 h-6 rounded-full bg-accent/10 flex items-center justify-center shrink-0 mt-0.5 group-hover:bg-accent/20 transition-colors">
